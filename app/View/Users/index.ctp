			    ...
			    <table id="listado" class="dynamicTable table table-striped">
					...
					<tr>
						...
						<td style="text-align: center" nowrap class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $user['User']['id']), array('title' => 'Eliminar', 'escape' => false), __('Está seguro que quiere eliminar # %s?', $user['User']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				    </tbody>
