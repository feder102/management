                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                            		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Editar Size'), array('action' => 'edit', $size['Size']['id']), array('escape' => false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Eliminar Size'), array('action' => 'delete', $size['Size']['id']), array('escape' => false), __('Está seguro que quiere eliminar # %s?', $size['Size']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;Listar Sizes'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;Nuevo Size'), array('action' => 'add'), array('escape' => false)); ?> </li>
...
<div class="related row">
    <div class="col-md-12">
		...
		<th style="text-align: center" nowrap><?php echo __('Stock'); ?></th>
                            ...
                            <tbody>
                                	<?php foreach ($size['Garment'] as $garment): ?>
		<tr>
